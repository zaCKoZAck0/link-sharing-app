    ...
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" {...props} xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_86_26570)">
                <path d="M12.25 0H3.75C1.67893 0 0 1.67893 0 3.75V12.25C0 14.3211 1.67893 16 3.75 16H12.25C14.3211 16 16 14.3211 16 12.25V3.75C16 1.67893 14.3211 0 12.25 0Z" fill="currentColor"/>
...
const MemoDevToIcon = React.memo(DevToIcon);
export default MemoDevToIcon;