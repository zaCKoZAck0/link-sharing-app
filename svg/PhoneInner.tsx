...
function PhoneInnerIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg className='absolute' xmlns="http://www.w3.org/2000/svg" width={286} height={612} {...props} viewBox="0 0 286 612" fill="none">
...
const MemoPhoneInnerIcon = React.memo(PhoneInnerIcon);
export default MemoPhoneInnerIcon;
